...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'backport:install';
     ...
     * @var string
     */
    protected $description = 'Install the backport package';
    ...
    public function initDatabase()
    {
        ...
        if ($userModel::count() == 0) {
            $this->call('db:seed', ['--class' => \Wiledia\Backport\Auth\Database\AdminTablesSeeder::class]);
        }
    }
    ...
    protected function initAdminDirectory()
    {
        ...
        $this->makeDir('/');
        $this->line('<info>Backport directory was created:</info> '.str_replace(base_path(), '', $this->directory));
