...
class Builder
{
    ...
    {
        if (func_num_args() == 1) {
            return \Illuminate\Support\Arr::get($this->options, $option);
        }
    ...
    public function open($options = [])
    {
        ...
        $attributes['method'] = \Illuminate\Support\Arr::get($options, 'method', 'post');
        $attributes['accept-charset'] = 'UTF-8';

        $attributes['class'] = \Illuminate\Support\Arr::get($options, 'class');
