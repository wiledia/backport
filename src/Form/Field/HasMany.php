...
class HasMany extends Field
{
    ...
    public function getValidator(array $input)
    {
        ...
        \Illuminate\Support\Arr::forget($rules, NestedForm::REMOVE_FLAG_NAME);
    ...
    protected function formatValidationAttribute($input, $label, $column)
    {
        ...
        foreach (array_keys(\Illuminate\Support\Arr::dot($input)) as $key) {
            if (is_string($column)) {
    ...
    protected function resetInputKey(array &$input, array $column)
    {
        ...
        foreach ($input[$this->column] as $index => $set) {
            ...
            foreach ($set as $name => $value) {
                 ...
                 * set new key
                 */
                \Illuminate\Support\Arr::set($input, "{$this->column}.$index.$newKey", $value);
                /*
                 * forget the old key and value
                 */
                \Illuminate\Support\Arr::forget($input, "{$this->column}.$index.$name");
            }
        }
    }
    ...
    protected function buildRelatedForms()
    {
        ...
        if ($values = old($this->column)) {
            ...
            foreach ($this->value as $data) {
                $key = \Illuminate\Support\Arr::get($data, $relation->getRelated()->getKeyName());
