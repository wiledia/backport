...
class Column
{
    ...
    {
        return \Illuminate\Support\Arr::get(static::$htmlAttributes, $name, '');
    }
    ...
    public function using(array $values, $default = null)
    {
        return $this->display(function ($value) use ($values, $default) {
            ...
            return \Illuminate\Support\Arr::get($values, $value, $default);
        });
    }
    ...
    public function fill(array $data)
    {
        foreach ($data as $key => &$row) {
            $this->original = $value = \Illuminate\Support\Arr::get($row, $this->name);

            $value = $this->htmlEntityEncode($value);

            \Illuminate\Support\Arr::set($row, $this->name, $value);
