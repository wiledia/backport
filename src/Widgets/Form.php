...
class Form implements Renderable
{
    ...
    {
        \Illuminate\Support\Arr::forget($this->attributes, 'pjax-container');
    ...
    {
        $class = \Illuminate\Support\Arr::get(\Wiledia\Backport\Form::$availableFields, $method);
    ...
    public function __call($method, $arguments)
    {
        if ($className = static::findFieldClass($method)) {
            $name = \Illuminate\Support\Arr::get($arguments, 0, '');
